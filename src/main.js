...
const addAttributes = (_element) => {
  ...
  let vv = selectedElement.name.replace(/_/g, " ");
  attributesList.push({
    ...
    while (!done) {
      ...
      for (var i = 0; i < layer.elements.length; i++) {
        ...
        if (random < 0) {
          ...
          // examples:
          if (layer.name === 'Headwear') {
            if (name == 'Balaclava') {
              layerMap.set('Mouth', findElement(_layers, 'Mouth', 'None'));
            }
          }
          // if(layer.name==='hair'){
